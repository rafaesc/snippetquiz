...
export default function GenerateQuiz() {
    ...
    const { data: entriesData, isLoading: entriesLoading, error: entriesError } = useQuery({
        ...
        queryFn: () => apiService.getContentEntries(selectedBankId, currentPage, entriesPerPage),
    ...
    return (
        <div className="p-4 md:p-6 space-y-6">
            ...
            <div>
                <h1 className="text-2xl font-bold">Generate Quiz</h1>
                <p className="text-muted-foreground">Create a new quiz from your content banks</p>
            </div>
                ...
                <CardHeader>
                    <CardTitle className="flex items-center justify-between">
                        ...
                        <Button
                            ...
                            className="text-xs"
                        >
                            <a href="/dashboard/content-banks" target="_blank" rel="noopener noreferrer">
                        ...
                        <div className="mt-3 p-3 bg-muted rounded-lg">
                            <div className="flex items-center justify-between">
                                ...
                                <Badge variant="outline">
                                    Created {new Date(selectedBank.createdAt).toLocaleDateString()}
                                </Badge>
                            </div>
                        </div>
                    )}
                    ...
                    <CardHeader>
                        ...
                        <p className="text-sm text-muted-foreground">
                            {entriesLoading ? 'Loading entries...' : 
                             ...
                             entriesData ? `Showing ${entries.length} of ${entriesData.pagination.total} entries (Page ${currentPage} of ${totalEntryPages})` :
                             'No entries found'}
                        </p>
                    </CardHeader>
                    <CardContent>
                        {entriesLoading ? (
                            <div className="text-center py-4">
                                <p className="text-muted-foreground">Loading content entries...</p>
                            </div>
                        ) : entriesError ? (
                            <Alert>
                                <AlertCircle className="h-4 w-4" />
                            ...
                            <Alert>
                                <AlertCircle className="h-4 w-4" />
                                <AlertDescription>
                                    This content bank appears to be empty. Add some content entries to generate a quiz.
                                </AlertDescription>
                            </Alert>
                        )}
                    </CardContent>
