...
*/}}
{{- define "helpers.postgresql.host" -}}
...
*/}}
{{- define "helpers.postgresql.port" -}}
{{- if .Values.postgresql.jdbcUri -}}
{{- $uri := .Values.postgresql.jdbcUri -}}
{{- $withoutPrefix := regexReplaceAll "^jdbc:postgresql://" $uri "" -}}
{{- $hostPort := regexReplaceAll "/.*$" $withoutPrefix "" -}}
...
*/}}
{{- define "helpers.postgresql.database" -}}
{{- if .Values.postgresql.jdbcUri -}}
{{- $uri := .Values.postgresql.jdbcUri -}}
{{- $withoutPrefix := regexReplaceAll "^jdbc:postgresql://[^/]+/" $uri "" -}}
...
*/}}
{{- define "helpers.postgresql.user" -}}
{{- if .Values.postgresql.jdbcUri -}}
{{- $uri := .Values.postgresql.jdbcUri -}}
...
*/}}
{{- define "helpers.postgresql.password" -}}
{{- if .Values.postgresql.jdbcUri -}}
{{- $uri := .Values.postgresql.jdbcUri -}}
