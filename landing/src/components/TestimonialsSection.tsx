  ...
  const testimonials = [
    {
      ...
      content: "SnippetQuiz has revolutionized how I process research papers. I can now turn complex medical studies into digestible quizzes that help me retain critical information for my work.",
      rating: 5
    },
    {
      name: "Marcus Johnson",
      ...
      content: "The Chrome extension is a game-changer! I save programming tutorials and articles, then SnippetQuiz creates perfect practice questions. My coding skills have improved dramatically.",
      rating: 5
    },
    {
      ...
      content: "As someone who consumes a lot of educational content, SnippetQuiz helps me actually retain what I learn. The AI-generated quizzes are incredibly intelligent and contextually relevant.",
      rating: 5
    }
  ];
      ...
      <div className="section-container">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="section-subtitle text-gray-600 mx-auto">
            Join thousands of learners who have transformed their study habits with SnippetQuiz's intelligent quiz generation.
          </p>
        </div>
