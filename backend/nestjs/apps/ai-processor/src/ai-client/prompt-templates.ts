export class PromptTemplates {
    ...
    static getTopicGenerationPrompt(
        ...
        const prompt = `You are an expert content analyst. Your task is to generate relevant, specific topics based on the provided content.
...
Please provide ONLY the topics as a JSON array of strings.`;
     ...
     */
    static getTopicGenerationJsonSchema(): Record<string, any> {
        return {
