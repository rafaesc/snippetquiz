...
class AITopicsAddedIntegrationEventSerdeTest {
    ...
    void deserialize_reconstructs_topics_added_integration_event() throws Exception {
        ...
        data.put("type", Utils.getEventName(AITopicsAddedIntegrationEvent.class));
        ...
        assertInstanceOf(AITopicsAddedIntegrationEvent.class, result);
        var reconstructed = (AITopicsAddedIntegrationEvent) result;
