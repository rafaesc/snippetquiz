...
class AiGenerationService(ai_generation_pb2_grpc.AiGenerationServiceServicer):
    def GenerateQuiz(self, request, context):
        ...
        try:
            ...
            for i, content_entry in enumerate(request.content_entries):
                ...
                for chunk_idx, chunk in enumerate(chunks):
                    ...
                    try:
                        ...
                        print(
                            f"Generated {len(chunk_questions)} questions from chunk {chunk_idx + 1}"
                        )
            ...
            completed_message = ai_generation_pb2.QuizGenerationProgress(completed=True)
    ...
    def GenerateTopics(self, request, context):
        ...
        try:
            ...
            response = ai_generation_pb2.GenerateTopicsResponse(topics=generated_topics)
...
def serve():
    ...
    kafka_thread = threading.Thread(target=kafka_consumer.start_consumer, daemon=True)
    kafka_thread.start()
