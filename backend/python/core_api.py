...
class CoreApiClient:
    ...
    def _make_request(self, endpoint: str, user_id: str, method: str = "GET") -> Optional[Dict[Any, Any]]:
    ...
    def get_content_entry(self, content_entry_id: str, user_id: str) -> Optional[Dict[Any, Any]]:
