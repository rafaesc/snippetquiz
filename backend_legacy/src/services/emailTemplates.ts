...
export const getVerificationEmailTemplate = (data: EmailTemplateData): string => {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p>Hi ${data.name},</p>
      <p>Thank you for registering with SnippetQuiz. Please verify your email address by clicking the button below:</p>
      ...
      <p>If you didn't create an account with SnippetQuiz, please ignore this email.</p>
      <hr style="margin: 30px 0; border: none; border-top: 1px solid #eee;">
      <p style="color: #666; font-size: 12px;">SnippetQuiz Team</p>
    </div>
  `;
};
